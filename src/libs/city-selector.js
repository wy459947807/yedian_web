const LIST = [{
    ...
    "cityList": [{
        "name": "成都市",
        "areaList": ["市辖区", "锦江区", "青羊区", "金牛区", "武侯区", "成华区", "龙泉驿区", "青白江区", "新都区", "温江区", "金堂县", "双流县", "郫　县", "大邑县", "蒲江县", "新津县", "都江堰市", "彭州市", "邛崃市", "崇州市"]
    }, {
        "name": "内江市",
    ...
    "cityList": [{
        ...
        "name": "固原市",
        "areaList": ["市辖区", "原州区", "西吉县", "隆德县", "泾源县", "彭阳县"]
    }, {
        "name": "中卫市",
        "areaList": ["市辖区", "沙坡头区", "中宁县", "海原县"]
    }]
}, {
    "name": "新疆维吾尔自治区",
    "cityList": [{
...
LIST.forEach(function(province) {
    map[province.name] = {};
    province.cityList.forEach(function(city) {
        map[province.name][city.name] = city.areaList;
    });
});

let provinceList = Object.keys(map);
...
module.exports = {
    ...
    getCityList(province) {
        return Object.keys(map[province]);
    },
    getDistrictList(province, city) {
        return map[province][city];
    }
};